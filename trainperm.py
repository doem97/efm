...
class JigsawNet(nn.Module):
    ...
    def __init__(self, sinkhorn_iter=0, N=6, patch_size=56):
        ...
        classifier_input_dim = self.embedding_dim * self.patch_num
...
def get_args():
    ...
    parser.add_argument(
        "--patches", type=int, default=4, help="Number of patches per dimension"
    )
    parser.add_argument("--batch_size", type=int, default=128, help="Batch size")
    parser.add_argument("--epochs", type=int, default=100, help="Number of epochs")
    parser.add_argument(
        "--sinkhorn_iter", type=int, default=5, help="Number of Sinkhorn iterations"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--dataset_dir",
        type=str,
        default="./data/imagenet/ILSVRC/Data/CLS-LOC",
        help="Directory of the dataset",
    )
    parser.add_argument(
        "--my_dataset_dir",
        type=str,
        default="./data/cspuzzle",
        help="Directory of my dataset",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=2,
        help="Number of pairs for something (please specify)",
    )
...
if __name__ == "__main__":
    ...
    assert (
        image_size == patch_size * N
    ), "Image size must be equal to patch size times number of patches"
    dataset_dir = Path(args.dataset_dir)
    my_dataset_dir = Path(args.my_dataset_dir)
    output_dir = Path(f"{args.output_dir}/in1k_{image_size}_{patch_size}_{N}")
